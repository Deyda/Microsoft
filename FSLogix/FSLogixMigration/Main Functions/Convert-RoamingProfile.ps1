<#
    ...
    #>
Function Convert-RoamingProfile {
            ...
            If (($P).Target -ne "Cannot Copy") {
                ...
                if (!(Test-Path (($P).Target.Substring(0, ($P).Target.LastIndexOf('.')) + "*"))) {
                    ...
                    if ($Drive) {
                        ...
                        try {
                            Copy-Profile -ProfilePath (($P).ProfilePath) -Drive $Drive @CopyParams -ErrorAction Stop
                        }
                        catch {
                        ...
                        if ($null -eq (Compare-Object -ReferenceObject (Get-ChildItem ($P).ProfilePath -Recurse -force) -DifferenceObject (Get-ChildItem $Destination -Recurse -force))) {
