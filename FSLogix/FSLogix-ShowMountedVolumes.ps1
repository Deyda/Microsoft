...
& '.\FSLogix-ShowMountedVolumes.ps1' -verbose -label billybob  -noUsedSpace | Out-GridView
...
& '.\FSLogix-ShowMountedVolumes.ps1' | Sort-Object -Property 'Free Capacity %' | Format-Table -Autosize
