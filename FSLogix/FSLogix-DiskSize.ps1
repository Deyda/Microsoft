...
.EXAMPLE
    .\FSLogix-DiskSize.ps1 -ContainerPath \\Server\Share
    Gets all containers in the \\Server\Share Directory, sorts by Gb, and outputs logfile to the \\Server\Share Directory
.EXAMPLE
    .\FSLogix-DiskSize.ps1 -ContainerPath \\Server\Share -Type Profile -exportcsv -CSVPath c:\temp\bob\stuff.csv -LogPath c:\temp\bob\stuff.log -SortBy MB -LogRollover 2
...
.EXAMPLE
    .\FSLogix-DiskSize.ps1 -ContainerPath \\Server\Share -Type Office -exportcsv -SortBy MB
