...
'.\Microsoft-CheckStartProcesses.ps1'  -processes "outlook.exe","lync.exe:/fromrunkey" -startDelay 75 -auto
...
'.\Microsoft-CheckStartProcesses.ps1'  -processes "outlook.exe","lync.exe:/fromrunkey" -startDelay 75 -auto -install
