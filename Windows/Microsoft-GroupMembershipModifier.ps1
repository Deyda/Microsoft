...
& '.\Microsoft-GroupMembershipModifier.ps1' -machines machine01,machines02 -users user1,user2 -group "Remote Desktop Users"

Add the specified users to the specified group on the specified machines

.EXAMPLE

& '.\Microsoft-GroupMembershipModifier.ps1' -machinesFile c:\temp\machines.txt -usersFile c:\temp\users.txt -remove
