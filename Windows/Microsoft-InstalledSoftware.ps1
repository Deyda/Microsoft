...
& '.\Microsoft-InstalledSoftware.ps1' -gridview -computers .

Retrieve installed software details on the local computer and show in a grid view

.EXAMPLE

& '.\Microsoft-InstalledSoftware.ps1' -computers computer1,computer2,computer3 -exportcsv installed.software.csv
...
& '.\Microsoft-InstalledSoftware.ps1' -gridview -importcsv computers.csv -computerColumnName Machine
...
& '.\Microsoft-InstalledSoftware.ps1' -gridview -computers . -uninstall
...
& '.\Microsoft-InstalledSoftware.ps1' -computers . -remove '7\-zip','Notepad\+\+' -Confirm:$false
...
& '.\Microsoft-InstalledSoftware.ps1' -computers . -remove 'Acrobat Reader' -Confirm:$false -silent
