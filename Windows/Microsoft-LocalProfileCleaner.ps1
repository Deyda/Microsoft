...
& '.\Microsoft-LocalProfileCleaner.ps1' -excludeLocal -machines ctx[pt]\d\d\d -excludeUsers [^A-Z]SVC-
...
& '.\Microsoft-LocalProfileCleaner.ps1' -OU CONTOSO.COM//Servers/Workplace/Citrix XenApp/Prod/Infrastructure Servers -includeUsers fredbloggs,johndoe
