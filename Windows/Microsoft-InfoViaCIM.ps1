...
& '.\Microsoft-InfoViaCIM.ps1' -computersFile c:\temp\puters.txt -Verbose -outputFolder C:\Temp\CIM -common
...
& '.\Microsoft-InfoViaCIM.ps1' -computers machine1,machine2 -outputFolder C:\Temp\CIM -classes win32_service,win32_process
...
& '.\Microsoft-InfoViaCIM.ps1' -outputFolder C:\Temp\CIM -classes win32_service,win32_process
