...
& '.\Microsoft-DeleteProfileForGroupMember.ps1' -group 'guyrleech\Delete Profiles'
...
& '.\Microsoft-DeleteProfileForGroupMember.ps1' -group 'guyrleech\Delete Profiles' -confirm:$false
